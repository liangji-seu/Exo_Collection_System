...
def test_condition_combo_exposes_phase_conditions(
    ...
    try:
        ...
        # 第二期特殊：匀变速/变坡度 + 意图类 + 无约束/固定约束类 + 主动/被动关节类（96 条，成对穿戴）。
        select_category("SPECIAL")
        assert window.condition_combo.count() == 96
        assert set(combo_codes()) == {
            ...
            "INTENT_TEST_NOEXO",
            "INTENT_TEST_EXO",
            "FREE_ACTIVE_FORWARD_NOEXO",
            "FREE_ACTIVE_FORWARD_EXO",
            "FREE_ACTIVE_LATERAL_NOEXO",
            "FREE_ACTIVE_LATERAL_EXO",
            "FREE_ACTIVE_BACKWARD_NOEXO",
            "FREE_ACTIVE_BACKWARD_EXO",
            "FREE_PASSIVE_FORWARD_NOEXO",
            "FREE_PASSIVE_FORWARD_EXO",
            "FREE_PASSIVE_LATERAL_NOEXO",
            "FREE_PASSIVE_LATERAL_EXO",
            "FREE_PASSIVE_BACKWARD_NOEXO",
            "FREE_PASSIVE_BACKWARD_EXO",
            "FIXED_ACTIVE_FORWARD_NOEXO",
            "FIXED_ACTIVE_FORWARD_EXO",
            "FIXED_ACTIVE_LATERAL_NOEXO",
            "FIXED_ACTIVE_LATERAL_EXO",
            "FIXED_ACTIVE_BACKWARD_NOEXO",
            "FIXED_ACTIVE_BACKWARD_EXO",
            "FIXED_PASSIVE_FORWARD_NOEXO",
            "FIXED_PASSIVE_FORWARD_EXO",
            "FIXED_PASSIVE_LATERAL_NOEXO",
            "FIXED_PASSIVE_LATERAL_EXO",
            "FIXED_PASSIVE_BACKWARD_NOEXO",
            "FIXED_PASSIVE_BACKWARD_EXO",
            "ACTIVE_CONSTRAINED_HIP_FLEX_NOEXO",
            "ACTIVE_CONSTRAINED_HIP_FLEX_EXO",
            "ACTIVE_CONSTRAINED_HIP_EXT_NOEXO",
            "ACTIVE_CONSTRAINED_HIP_EXT_EXO",
            "ACTIVE_CONSTRAINED_KNEE_FLEX_NOEXO",
            "ACTIVE_CONSTRAINED_KNEE_FLEX_EXO",
            "ACTIVE_CONSTRAINED_KNEE_EXT_NOEXO",
            "ACTIVE_CONSTRAINED_KNEE_EXT_EXO",
            "ACTIVE_CONSTRAINED_ABDUCT_NOEXO",
            "ACTIVE_CONSTRAINED_ABDUCT_EXO",
            "ACTIVE_FREE_SLIGHT_HIP_FLEX_NOEXO",
            "ACTIVE_FREE_SLIGHT_HIP_FLEX_EXO",
            "ACTIVE_FREE_SLIGHT_HIP_EXT_NOEXO",
            "ACTIVE_FREE_SLIGHT_HIP_EXT_EXO",
            "ACTIVE_FREE_SLIGHT_KNEE_FLEX_NOEXO",
            "ACTIVE_FREE_SLIGHT_KNEE_FLEX_EXO",
            "ACTIVE_FREE_SLIGHT_KNEE_EXT_NOEXO",
            "ACTIVE_FREE_SLIGHT_KNEE_EXT_EXO",
            "ACTIVE_FREE_SLIGHT_ABDUCT_NOEXO",
            "ACTIVE_FREE_SLIGHT_ABDUCT_EXO",
            "ACTIVE_FREE_LARGE_HIP_FLEX_NOEXO",
            "ACTIVE_FREE_LARGE_HIP_FLEX_EXO",
            "ACTIVE_FREE_LARGE_HIP_EXT_NOEXO",
            "ACTIVE_FREE_LARGE_HIP_EXT_EXO",
            "ACTIVE_FREE_LARGE_KNEE_FLEX_NOEXO",
            "ACTIVE_FREE_LARGE_KNEE_FLEX_EXO",
            "ACTIVE_FREE_LARGE_KNEE_EXT_NOEXO",
            "ACTIVE_FREE_LARGE_KNEE_EXT_EXO",
            "ACTIVE_FREE_LARGE_ABDUCT_NOEXO",
            "ACTIVE_FREE_LARGE_ABDUCT_EXO",
            "PASSIVE_CONSTRAINED_HIP_FLEX_NOEXO",
            "PASSIVE_CONSTRAINED_HIP_FLEX_EXO",
            "PASSIVE_CONSTRAINED_HIP_EXT_NOEXO",
            "PASSIVE_CONSTRAINED_HIP_EXT_EXO",
            "PASSIVE_CONSTRAINED_KNEE_FLEX_NOEXO",
            "PASSIVE_CONSTRAINED_KNEE_FLEX_EXO",
            "PASSIVE_CONSTRAINED_KNEE_EXT_NOEXO",
            "PASSIVE_CONSTRAINED_KNEE_EXT_EXO",
            "PASSIVE_CONSTRAINED_ABDUCT_NOEXO",
            "PASSIVE_CONSTRAINED_ABDUCT_EXO",
            "PASSIVE_FREE_SLIGHT_HIP_FLEX_NOEXO",
            "PASSIVE_FREE_SLIGHT_HIP_FLEX_EXO",
            "PASSIVE_FREE_SLIGHT_HIP_EXT_NOEXO",
            "PASSIVE_FREE_SLIGHT_HIP_EXT_EXO",
            "PASSIVE_FREE_SLIGHT_KNEE_FLEX_NOEXO",
            "PASSIVE_FREE_SLIGHT_KNEE_FLEX_EXO",
            "PASSIVE_FREE_SLIGHT_KNEE_EXT_NOEXO",
            "PASSIVE_FREE_SLIGHT_KNEE_EXT_EXO",
            "PASSIVE_FREE_SLIGHT_ABDUCT_NOEXO",
            "PASSIVE_FREE_SLIGHT_ABDUCT_EXO",
            "PASSIVE_FREE_LARGE_HIP_FLEX_NOEXO",
            "PASSIVE_FREE_LARGE_HIP_FLEX_EXO",
            "PASSIVE_FREE_LARGE_HIP_EXT_NOEXO",
            "PASSIVE_FREE_LARGE_HIP_EXT_EXO",
            "PASSIVE_FREE_LARGE_KNEE_FLEX_NOEXO",
            "PASSIVE_FREE_LARGE_KNEE_FLEX_EXO",
            "PASSIVE_FREE_LARGE_KNEE_EXT_NOEXO",
            "PASSIVE_FREE_LARGE_KNEE_EXT_EXO",
